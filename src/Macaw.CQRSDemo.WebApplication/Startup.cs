...
using Macaw.CQRSDemo.MatchPlay.CommandStack;
...
namespace Macaw.CQRSDemo.WebApplication
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddInfrastructureReposities();
            services.AddInfrastructureEventSourcing();
            services.AddMatchQueryStack();
            services.AddMatchPlayCommandStack();
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory, IEventBus eventBus)
        {
            ...
            eventBus.RegisterMatchPlayCommandStack();
            eventBus.RegisterLiveScoreHandler();
